...
public class history extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference userHistoryDatabase = FirebaseDatabase.getInstance().getReference().child("driver").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("history");
                    ...
                    for (DataSnapshot ds : dataSnapshot.getChildren()){
                        for(DataSnapshot d: ds.getChildren()){
                            ...
                            {resultsHistory.add("Customer Id=" +" "+d.getValue().toString()+"\n ");
                                ...
                                if(d.getKey().equals("Source"))
                                {//double cost=(double)d.getValue();
                                    sad="Source Address:"+getAddress(Double.parseDouble(d.child("latitude").getValue().toString()),Double.parseDouble(d.child("longitude").getValue().toString()))+"\n";
                                }
                                if(d.getKey().equals("Destination"))
                                {//double cost=(double)d.getValue();
                                    dad="Destination Address:"+getAddress(Double.parseDouble(d.child("latitude").getValue().toString()),Double.parseDouble(d.child("longitude").getValue().toString()))+"\n";
                                }
