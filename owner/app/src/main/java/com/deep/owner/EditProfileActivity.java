...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("owner").child(uid);
...
//                    lastname.setText(user.l_name);
    ...
    private void updateProfile(String firstname, String lastname,String phone) {
        FirebaseDatabase.getInstance().getReference("owner").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("f_name").setValue(firstname);
        FirebaseDatabase.getInstance().getReference("owner").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("l_name").setValue(lastname);
        FirebaseDatabase.getInstance().getReference("owner").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("phone").setValue(phone);
